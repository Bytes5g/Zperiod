...
export const changelogLocales = {
  ...
  "ar": {
    ...
    "1.2.0": {
      "date": "2026-03-01",
      "changes": [
        "صفحة إعدادات جديدة مع التحكم في سرعة الرسوم المتحركة والإيقاف المؤقت",
        "شريط تنقل مبسط - تم نقل الروابط إلى بطاقات الإعدادات المعيارية",
        "صندوق الاقتراحات مع رقائق سريعة للتعليقات السريعة",
        "إصلاح أخطاء التفاعل السحب/الإغلاق لللوحة",
        "دقة محسنة لكشف الأجهزة المحمولة",
        "دليل صفحة الهبوط UX والتنقل للجوال"
      ]
    },
    "1.1.0": {
      "date": "2026-02-26",
      "changes": [
        "إعادة هيكلة معيارية CSS/JS للصيانة",
        "صفحة هبوط محمولة مع عرض الميزات",
        "كشف دقيق للجهاز المحمول مقابل سطح المكتب",
        "نقطة فاصل ورقة العمل سريعة الاستجابة معايرة إلى 840 بكسل",
        "حجم خط التكافؤ الإلكتروني المخصص",
        "إصلاح عرض صيغة الأيون (CH₃COO⁻) والتصميم",
        "تصميم أدوات معيارية للبطاقة النمطية مع عنصر/أيون Modals"
      ]
    },
    "1.0.0": {
      "date": "2026-02-07",
      "changes": [
        "الإفراج الرسمي v1.0 - Zperiod أصبح عام",
        "118 عنصراً مع بيانات كيميائية كاملة",
        "نماذج ذرات ثلاثية الأبعاد مع مدارات إلكترونية تفاعلية",
        "محرك الأيونات مع أكثر من 50 أيون مشترك",
    ...
    "0.5.0": {
      "date": "2026-01-14",
      "changes": [
        "جدول الأيونات والوصول السريع والتحقق من الذوبان",
        "تحسينات واجهة المستخدم الرئيسية في جميع الألواح",
        "وثائق README الشاملة"
      ]
    },
    "0.1.0": {
      "date": "2025-12-29",
      "changes": [
        "الالتزام الأولي - نموذج أولي لجدول دوري تفاعلي",
        "إصلاح توافق WebGL للعرض بين الأجهزة",
        "للتنقل بين الصفحات، اسحب/مرر على الشاشة",
        "خط أنابيب تصغير الأصول والتعتيم"
      ]
    }
  },
    "fa": {
